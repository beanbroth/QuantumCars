...
namespace Deform
{
    [Deformer(Name = "MyLattice", Description = "Free-form deform a mesh using lattice control points", Type = typeof(MyLatticeDeformer))]
    public class MyLatticeDeformer : Deformer
    {
        ...
        public void SetControlPointFromIndex(int index, float3 controlPoint)
        {
